...
export const MAKAMS: Makam[] = [
  {
    ...
    scale: [
      ...
      { degree: 3, name: 'Si Koma b', cents: 350, westernNearest: 'Bb', isCharacteristic: true },
      { degree: 4, name: 'Do', cents: 498, westernNearest: 'C' },
      { degree: 5, name: 'Re', cents: 702, westernNearest: 'D' },
      { degree: 6, name: 'Mi Koma b', cents: 851, westernNearest: 'Eb', isCharacteristic: true },
  ...
  },
  {
    ...
    scale: [
      ...
      { degree: 2, name: 'Si b koma+', cents: 151, westernNearest: 'Bb', isCharacteristic: true },
  ...
  },
  {
    ...
    scale: [
      ...
      { degree: 2, name: 'Mi b', cents: 90, westernNearest: 'Eb', isCharacteristic: true },
      ...
      { degree: 6, name: 'Si b', cents: 792, westernNearest: 'Bb' },
  ...
  },
  {
    ...
    scale: [
      { degree: 1, name: 'Re', cents: 0, westernNearest: 'D' },
      { degree: 2, name: 'Mi b koma+', cents: 151, westernNearest: 'Eb', isCharacteristic: true },
      { degree: 3, name: 'Fa', cents: 294, westernNearest: 'F' },
      { degree: 4, name: 'Sol b', cents: 430, westernNearest: 'Gb', isCharacteristic: true },
      { degree: 5, name: 'La b', cents: 566, westernNearest: 'Ab' },
      { degree: 6, name: 'Si b', cents: 792, westernNearest: 'Bb' },
      { degree: 7, name: 'Do', cents: 996, westernNearest: 'C' },
      { degree: 8, name: 'Re', cents: 1200, westernNearest: 'D' },
    ],
  ...
  },
  {
    ...
    guclu: 'Si b koma+ (Bb+)',
    scale: [
      { degree: 1, name: 'Mi Koma b', cents: 0, westernNearest: 'Eb', isCharacteristic: false },
      ...
      { degree: 5, name: 'Si b koma+', cents: 702, westernNearest: 'Bb', isCharacteristic: false },
      { degree: 6, name: 'Do', cents: 906, westernNearest: 'C' },
      { degree: 7, name: 'Re', cents: 1088, westernNearest: 'D' },
      { degree: 8, name: 'Mi Koma b', cents: 1200, westernNearest: 'Eb' },
    ],
  ...
  },
  {
    ...
    scale: [
      { degree: 1, name: 'Re', cents: 0, westernNearest: 'D' },
      { degree: 2, name: 'Mi b', cents: 135, westernNearest: 'Eb', isCharacteristic: true },
      { degree: 3, name: 'Fa', cents: 294, westernNearest: 'F' },
      { degree: 4, name: 'Sol', cents: 498, westernNearest: 'G' },
      { degree: 5, name: 'La', cents: 702, westernNearest: 'A' },
      { degree: 6, name: 'Si b', cents: 792, westernNearest: 'Bb' },
  ...
  },
  {
    ...
    scale: [
      ...
      { degree: 6, name: 'Si b', cents: 792, westernNearest: 'Bb', isCharacteristic: false },
