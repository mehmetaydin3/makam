...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'The Oud',
        image: { uri: 'https://en.wikipedia.org/w/index.php?title=Special:Redirect/file/Arabic_oud.jpg&width=400', caption: 'The oud — fretless, every note found by ear' },
      ...
      {
        heading: 'The Kemençe',
        image: { uri: 'https://en.wikipedia.org/w/index.php?title=Special:Redirect/file/Kemence.jpg&width=400', caption: 'The kemençe — nasal, intense, unmistakable' },
      ...
      {
        heading: 'The Kanun',
        image: { uri: 'https://en.wikipedia.org/w/index.php?title=Special:Redirect/file/Qanun_instrument.jpg&width=400', caption: 'The kanun — 72 strings, microtonal levers on every course' },
