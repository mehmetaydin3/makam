...
/**
 * Modal Jazz lessons — 6 lessons, grouped into 3 thematic categories.
 * Uses the shared Lesson/LessonPage types from education.ts and the shared
 * paged LessonReader. Strings inlined (no i18n layer, per app consistency).
 */

export type JazzCategory = 'foundations' | 'modes' | 'practice';

export const JAZZ_CATEGORY_ORDER: JazzCategory[] = ['foundations', 'modes', 'practice'];

export const JAZZ_CATEGORY_LABELS: Record<JazzCategory, string> = {
...
export const LESSONS: Lesson[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        callout: 'Same notes. Different gravity. That is the entire idea.',
      },
      {
        id: 'l1-p3',
        type: 'concept',
      ...
      },
      {
        ...
        callout: 'Each lesson introduces the color note of each mode before the scale.',
      },
      {
        id: 'l1-p5',
        type: 'summary',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        modeId: 'ionian',
        callout: 'The major 7th is one half step below the octave. It gives Ionian its luminous quality.',
      },
      {
        id: 'l2-p3',
        type: 'intro',
      ...
      },
      {
        ...
        modeId: 'dorian',
        callout: 'Miles Davis built Kind of Blue around D Dorian. "So What" is the purest example.',
      },
      {
        id: 'l2-p5',
        type: 'compare',
        ...
        callout: 'The difference is two notes: the 3rd and 7th (major vs minor). But the feeling difference is much larger.',
      },
      {
        id: 'l2-p6',
        type: 'chord',
        ...
        callout: '"So What": D Dorian over Dm7 for 16 bars. Listen to how long it sustains.',
      },
      {
        id: 'l2-p7',
        type: 'summary',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        modeId: 'lydian',
        callout: 'The #4 is a tritone above the root. In Lydian that tension is left unresolved — exactly what creates the floating feeling.',
      },
      {
        id: 'l3-p3',
        type: 'chord',
        ...
        modeId: 'lydian',
        callout: 'George Russell\'s Lydian Chromatic Concept (1953) argued that Lydian is the natural organizing sound of tonal music.',
      },
      {
        id: 'l3-p4',
        type: 'listen',
        ...
        modeId: 'mixolydian',
        callout: 'Every dominant 7th chord implies Mixolydian. The flat 7th in the chord and the mode are the same note.',
      },
      {
        id: 'l3-p5',
        type: 'chord',
      ...
      },
      {
        ...
        callout: 'Maj7 chord → Ionian or Lydian. Dominant 7 chord → Mixolydian.',
      },
      {
        id: 'l3-p7',
        type: 'summary',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        modeId: 'aeolian',
        callout: 'Dorian vs Aeolian: the only difference is the 6th. Natural = Dorian (cool). Flat = Aeolian (melancholic).',
      },
      {
        id: 'l4-p3',
        type: 'listen',
        ...
        modeId: 'phrygian',
        callout: 'Coltrane\'s "Impressions" moves from D Dorian to Eb Phrygian. The tension increase is visceral.',
      },
      {
        id: 'l4-p4',
        type: 'listen',
        ...
        modeId: 'locrian',
        callout: 'Play B Locrian over Bø7 in a minor ii-V-i. That is the correct use of Locrian.',
      },
      {
        id: 'l4-p5',
        type: 'compare',
        ...
        callout: 'The minor modes form a spectrum: Dorian (neutral) → Aeolian → Phrygian → Locrian (darkest).',
      },
      {
        id: 'l4-p6',
        type: 'summary',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        callout: 'The #11 marking in a chord symbol is a direct instruction to use Lydian.',
      },
      {
        id: 'l5-p3',
        type: 'chord',
        ...
        callout: 'Altered dominants use the Altered scale — a melodic minor mode. Release 2 material.',
      },
      {
        id: 'l5-p4',
        type: 'chord',
      ...
      },
      {
        ...
        callout: 'This is the practical payoff: look at a chord symbol and immediately know which sound to reach for.',
      },
      {
        id: 'l5-p7',
        type: 'summary',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        callout: 'Sing the 6th degree over a minor chord. Does it want to go somewhere? Dorian. Does it feel like it arrived at sadness? Aeolian.',
      },
      {
        id: 'l6-p3',
        type: 'compare',
        ...
        callout: 'Play the 4th degree. Does it feel stable? Ionian. Does it want to rise? Lydian.',
      },
      {
        id: 'l6-p4',
        type: 'compare',
        ...
        callout: 'Locrian is the only mode where the tonic chord is diminished. That instability is immediate once you know to listen for it.',
      },
      {
        id: 'l6-p5',
        type: 'concept',
        ...
        callout: 'The Practice tab has ear training quizzes. Use them after every lesson.',
      },
      {
        id: 'l6-p6',
        type: 'summary',
        ...
        callout: 'Return to any mode in Browse and listen again. It will sound different now.',
      },
    ],
  },
];
