...
const makeStyles = (JAZZ_COLORS: JazzColorScheme) => StyleSheet.create({
  ...
  brightnessBadge: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: RADIUS.full },
  ...
  progressionPill: { backgroundColor: JAZZ_COLORS.surfaceRaised, borderRadius: RADIUS.full, paddingHorizontal: 12, paddingVertical: 5 },
  ...
  playerPill: { backgroundColor: JAZZ_COLORS.surface, borderRadius: RADIUS.full, borderWidth: 1, borderColor: JAZZ_COLORS.border, paddingHorizontal: 12, paddingVertical: 5 },
